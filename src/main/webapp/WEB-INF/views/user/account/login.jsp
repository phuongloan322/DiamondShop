					...
					<div class="well well-a">
						...
						<form:form action="dang-nhap" method="POST" modelAttribute="user">
							<div class="control-group">
								...
								<div class="controls">
									<form:input  id="email"  type="email" class="span3"
							...
							<div class="control-group">
								<label class="control-label" for="inputPassword">Mật
									khẩu</label>
								<div class="controls">
									<form:input  class="span3" id="password" type="password"
										placeholder="Mời nhập mật khẩu" path="password" />
								</div>
							</div>
							<div class="error-text">${ stt_login }</div>
							...
							<div class="traight">
								<p class="a"><span class="line">hoặc</span><p>
							</div>
							<div class="control-group">
								<div class="controls">
									<a href="<c:url value="/dang-ky"/>" class="CreateAcc" >Tạo tài khoản mới</a>
								</div>
							</div>
						</form:form>
