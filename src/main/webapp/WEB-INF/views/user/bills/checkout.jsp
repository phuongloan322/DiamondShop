...
<div class="well">
	<h3 class="title_thanhtoan">Thanh toán đơn hàng</h3>
	...
	<form:form action="checkout" method="POST" modelAttribute="bills" class="form-horizontal">
							...
							<div class="control-group">
								...
								<div class="controls">
 									<form:input id="email" type="email" class="spanthanhtoan" 
							...
							<div class="control-group">
								...
								<div class="controls">
									<form:input  type="text" class="spanthanhtoan"
							...
							<div class="control-group">
								...
								<div class="controls">
 									<form:textarea path="address" rows="5" cols="30" style="width: 400px"/> 
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Ghi chú <sup>*</sup></label>
								<div class="controls">
 									<form:textarea path="note" rows="5" cols="30" style="width: 400px"/> 
								</div>
							</div>
							<div class="control-group">
								<div class="controls">
